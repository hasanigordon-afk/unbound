  ...
  return (
    <>
      <button
        ...
        style={{ position: 'fixed', left: 16, bottom: 96, zIndex: 80 }}
      >
        Emergency Calm
      </button>
      {open && (
        <div className="fixed inset-0 z-[90] bg-black/55 backdrop-blur-xl flex items-center justify-center p-4">
          <section className="card-glow max-w-2xl w-full p-6 md:p-8 text-center relative">
            <button onClick={close} className="text-[var(--text-muted)]" style={{ position: 'absolute', right: 16, top: 16 }}><X className="w-5 h-5" /></button>
