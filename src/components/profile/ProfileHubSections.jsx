...
const sections = [
  ...
  { key: 'progress', title: 'My Progress', icon: Trophy, description: 'Streaks, meetings, check-ins, and weekly momentum.', options: ['Streaks', 'Meetings', 'Weekly progress'] },
  ...
  { key: 'settings', title: 'Settings', icon: Settings, description: 'Preferences, notifications, privacy, and app setup.', options: ['Notifications', 'Privacy', 'Preferences'] },
];
            ...
            <button key={section.key} id={section.key} onClick={() => setActive(section)} className="rounded-[30px] border border-white/12 bg-white/10 p-5 text-left shadow-xl backdrop-blur-2xl active:scale-[.98]">
              <div className="mb-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-amber-100/80">Open section</p>
                </div>
              </div>
