  ...
  return (
    <div style={{
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <p style={{ fontSize: 14, fontWeight: 800, color: "#fff", lineHeight: 1.25 }}>{msg.headline}</p>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 3 }}>
            <div style={{ height: 4, width: 60, borderRadius: 2, background: "rgba(255,255,255,0.1)", overflow: "hidden" }}>
            ...
            {actions.map(a => (
              <Link key={a.label} to={createPageUrl(a.href)} style={{ textDecoration: "none" }}>
                <div style={{
                  ...
                  <div>
                    <p style={{ fontSize: 13, fontWeight: 700, color: "#fff" }}>{a.label}</p>
                    <p style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginTop: 1 }}>{a.sub}</p>
                  </div>
                </div>
              </Link>
            ))}
