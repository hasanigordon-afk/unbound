...
const pillars = [
  { title: 'Recovery & Accountability', icon: HeartPulse, stat: '4 steady actions today', progress: 76, actions: [['Positive check-ins', '/RecoveryPath'], ['Sponsor support', '/InnerCircle'], ['Roadmap progress', '/RecoveryPath'], ['Achievements', '/PositiveProgressHub'], ['AI accountability companion', '/SuperAgentChat']] },
  ...
  return (
    <section>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {pillars.map(({ title, icon: PillarIcon, stat, progress, actions }) => (
          <div key={title} className="card p-5">
            <div className="mb-4 flex items-center gap-3">
              <div className="rounded-3xl bg-blue-300/15 p-3 text-blue-100"><PillarIcon className="h-6 w-6" /></div>
