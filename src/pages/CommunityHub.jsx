...
export default function CommunityHub() {
  return <WorkingSectionHub title="Community" subtitle="Stories, encouragement, and support without judgment." primaryAction={{ title: 'Community Highlights', description: 'Ah Ha Moments, recovery stories, testimonials, recovery posts, and encouragement are now together.' }} sections={[
